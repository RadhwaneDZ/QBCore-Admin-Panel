        ...
        <div class="main-card mb-9 card"> <!-- TABLE -->
            ...
            <div class="card text-center">
                <div class="card-header">Manage User Punishments</div>
                    <div class="card-body">
                    <button class="mb-2 mr-2 btn btn-primary btn-lg btn-block">BAN PLAYER</button>
                    <button class="mb-2 mr-2 btn btn-primary btn-lg btn-block">KICK PLAYER</button>
                    <button class="mb-2 mr-2 btn btn-primary btn-lg btn-block">CREATE NEW NOTE</button>
                </div>
            </div>
        </div>
        </div>
